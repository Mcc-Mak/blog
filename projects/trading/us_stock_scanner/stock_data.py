    ...
    def price_plot_data(self, data, methods, functions, key="Open"):
        ...
        for f in functions:
            if f == "regression":
                ...
                ret_func = ret.return_rate(y_open, y_close)  # get return rate(open_price, close_price)
                # print(ret_func)
                ...
                sentiments_table = s.get_sentiment_score([self.token])  # input: [token_code], output: [ df ]
                try:

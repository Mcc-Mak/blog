...
void loop() {
    ...
    digitalWrite(13, led);
    goPlus.Servo_write_angle(SERVO_NUM0,  a); delay(100);
    goPlus.Servo_write_angle(SERVO_NUM1 , a); delay(100);
    goPlus.Servo_write_angle(SERVO_NUM2 , a); delay(100);
    goPlus.Servo_write_angle(SERVO_NUM3 , a); delay(100);
    if (a > 180) {
      a = 10;
    }
    a = a + 170;
